...
SongDisplay.prototype = {
	...
	redrawSongInfo: function() {
		...
		this.ctxLegend.clearRect(0, 0, 1024, 1024);
		
		this.ctxLegend.textBaseline = "middle";
		this.ctxLegend.textAlign = "center";
		this.ctxLegend.fillStyle = '#FFF';
		this.ctxLegend.strokeStyle = "#888";
		
		this.ctxLegend.font = '25px serif';
		var middle = 512, addY=100;
		this.text(this.ctxLegend, this.displayAccessor.getDisplayTitle(), middle, 70+addY);
		
		this.ctxLegend.font = '20px sans-serif';
		this.text(this.ctxLegend, this.displayAccessor.getDisplaySubtitle(), middle, 125+addY);
		...
		this.text(this.ctxLegend, this.displayAccessor.getDisplayLine1(), middle, 190+addY);
		this.text(this.ctxLegend, this.displayAccessor.getDisplayLine2(), middle, 230+addY);
		this.text(this.ctxLegend, this.displayAccessor.getDisplayLine3(), middle, 270+addY);
		
		// hack: make sure dumb Firefox knows that redraw is needed..
		this.mozReflectLogo.style.visibility = "hidden";
		this.mozReflectLogo.style.visibility = "visible";
	},
	drawHelpInfo: function() {
		this.reqAnimationFrame();	// start the animation going
		...
		this.ctxLegend.font = '25px serif';
		var middle = 512, addY=100;
		this.text(this.ctxLegend, "Offline version of webVGM by Delek", middle, 70+addY);
		
		this.ctxLegend.font = '20px sans-serif';
		this.text(this.ctxLegend, "Drag and drop vgm files...", middle, 125+addY);
